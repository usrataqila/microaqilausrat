#pragma once
// ============ microaqila control_v4 configuration ============
...
#define DEFAULT_GAP_C     0.5     // STARTING hysteresis half-band
#define CTRL_PERIOD_MS    2500    // DHT22 minimum sampling interval is 2 s

// --- Adaptive threshold: the contribution this project is named after ---
// Rule, in one sentence: if the relays have been switching a lot lately,
// widen the band; if nothing has switched and we are sitting idle, tighten it.
#define DEFAULT_ADAPTIVE  1       // 1 = adaptive at boot, 0 = fixed
#define ADAPT_WINDOW_MS   60000   // how often the band is reviewed (1 min)
#define ADAPT_BUSY_SW     4       // switches per window that count as chatter
#define ADAPT_STEP_C      0.1     // how far the band moves per review
#define GAP_MIN_C         0.2     // never tighter than this
#define GAP_MAX_C         2.0     // never wider than this
