#pragma once
// ================= microaqila board configuration (diag_v4) =================
...
// [G] PC817 + RY-VCC jumper boards are LOW-trigger (IN pulled low = relay on).
// The click test verifies this; flip to 0 if the pattern comes out inverted.
